        ...
        <section className="py-20 min-h-screen flex items-center" ref={ref}>
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className={`bg-white p-6 rounded-lg shadow-md transition-all duration-1000 delay-100 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <section className="py-20 bg-gray-100 min-h-screen flex items-center">
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 md:pl-10">
              <h2 className="text-3xl font-bold mb-6">무물을 통해 얻을 수 있는 다양한 이점</h2>
              ...
              <p className="text-xl mt-4">
                지금 무물을 도입하여 시간 절약, 고객 만족도 향상, 그리고 성장을 직접 체험해보세요!
              </p>
            </div>
          </div>
        </section>
